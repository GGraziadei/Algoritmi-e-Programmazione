...
typedef struct {
    PG_KEY id; /*Rispetto la precedente versione, questo campo diventa PG_KEY (char*),
 * ammettendo più moduli non sono più certo dell' unicità della chiave e quindi non mi è possibile omettere il prefisso PG*/
    char *name,*class;
    stat_t stat;
    link_tabEquip equip;
}pg_t;
