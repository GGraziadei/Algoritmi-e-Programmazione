    ...
    do {
        ...
        switch (selezione) {
            ...
            case 2:{
                ...
                d1 = DAY_init(stdin);
                if(DAY_cmp(d1,QUOTAZIONI_minD(stock->quotazioniBST)) >= 0 &&
                    DAY_cmp(d1,QUOTAZIONI_maxD(stock->quotazioniBST)) <= 0){
                    q = QUOTAZIONI_search(stock->quotazioniBST,d1);
                ...
                } else printf("Inserire una data valida!\n");
            }
                break;
            case 3:{
                printf("Inserire data valida: ");
